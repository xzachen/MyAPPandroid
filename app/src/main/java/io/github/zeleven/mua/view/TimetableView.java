...
import io.github.zeleven.mua.activities.EditCourseActivity;
import io.github.zeleven.mua.activities.HomeActivity;
...
public class TimetableView extends ViewGroup {
    //    实现删除的URL
    private String Url = "http://xzacjy.pythonanywhere.com/myapp/deletecourse/";
        ...
        JsonObjectRequest request = new JsonObjectRequest(url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (status == 200) {
                            TastyToast.makeText(context, "删除成功", TastyToast.LENGTH_SHORT,
                                    TastyToast.SUCCESS);
                        } else if (status == 400) {
                            TastyToast.makeText(context, "删除失败", TastyToast.LENGTH_SHORT,
                                    TastyToast.ERROR);
                        }
                    }
    ...
    public class OnCourseItemClickListenerImp implements OnCourseItemClickListener {
        ...
        public void onCourseItemClick(final CourseModel course) {
            new SuperDialog.Builder((FragmentActivity) context).setRadius(30)
                    .setAlpha(1f)
                    .setTitle("课程详情")
                    .setMessage(course.toString())
                    .setPositiveButton("修改", new SuperDialog.OnClickPositiveListener() {
                        @Override
                        public void onClick(View v) {
                    ...
                    .setNegativeButton("返回", new SuperDialog.OnClickNegativeListener() {
                        @Override
                        public void onClick(View v) {
        ...
        @Override
        public void onLongCourseItemClick(final CourseModel course) {
            new SuperDialog.Builder((FragmentActivity) context).setRadius(30)
                    .setAlpha(1f)
                    .setTitle("删除课程")
                    .setMessage("确定删除该课程吗？")
                    .setPositiveButton("确定", Color.RED, new SuperDialog.OnClickPositiveListener() {
                        @Override
                        public void onClick(View v) {
                            int c = course.getCid();
                            deletecourse(Url + c);
